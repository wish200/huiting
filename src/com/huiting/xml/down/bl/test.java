...
public static void main(String[] arg){
		...
		try{ 
			com.huiting.xml.down.bean.RequestBean bean = new com.huiting.xml.down.bean.RequestBean();
			bean.setSendTime(new Timestamp(System.currentTimeMillis()));
			bean.setUUID(UUID.randomUUID().toString());
			bean.setRequestType("D08"); 
			bean.setUserID("1111");
			bean.setProgramID("111111");
			bean.setProgramName("啊啊");
			bean.setProgramPic("http://localhost:98080");
			bean.setProgramURL("http://localhost");
