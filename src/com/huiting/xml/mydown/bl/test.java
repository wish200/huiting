...
public static void main(String[] arg){
		...
		try{ 
			com.huiting.xml.mydown.bean.RequestBean bean = new com.huiting.xml.mydown.bean.RequestBean();
			bean.setSendTime(new Timestamp(System.currentTimeMillis()));
			bean.setUUID(UUID.randomUUID().toString());
			bean.setRequestType("W06");
			bean.setPage(0);
			bean.setUserID("1111");
			 
			 String jsonString = JSON.toJSONString(bean);
			String str=connect("http://localhost:8080/huiting/HuiTingAction.do?userid=111&sign=2222", jsonString);
