...
public class HuiTingAction  implements Action{
	...
	public String execute() throws Exception {
		...
		String httphead = "userid:"+req.getParameter("userid")+";Encoding:"+req.getCharacterEncoding()+";ContentType:"+req.getContentType()+";ReqAddr:"+req.getRemoteAddr()+";ReqPort:"+req.getRemotePort()+";ReqURI:"+req.getRequestURI();
